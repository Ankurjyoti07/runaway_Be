...
v1.4
09/07/2019
This code was developed by Michael Abdul-Masih and modified by Sanjay Sekaran
Modified by Julia Bodensteiner
Instituut voor Sterrenkunde, KU Leuven, Belgium
michael.abdulmasih@kuleuven.be
sanjay.sekaran@kuleuven.be
julia.bodensteiner@kuleuven.be
'''
...
outfolder = './'  # folder to save output spectra in, should exist beforehand
